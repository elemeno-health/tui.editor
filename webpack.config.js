...
const ENTRY_CONVERTOR = './src/js/indexConvertor.js';
...
const defaultConfigs = Array(2).fill(0).map(() => {
  return {
    cache: false,
    output: {
      path: DIST_PATH,
...
defaultConfigs[1].entry = {
  'EHConvertor': ENTRY_CONVERTOR
};
defaultConfigs[1].externals = [{
  // 'tui-color-picker': {
  //   commonjs: 'tui-color-picker',
  //   commonjs2: 'tui-color-picker',
  //   amd: 'tui-color-picker',
...
defaultConfigs[1].output.library = ['tui', 'EHConvertor'];
